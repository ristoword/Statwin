...
export const SPORT_CATALOG: SportDefinition[] = [
  ...
  },
  {
    ...
    status: 'predisposed',
    focus: 'Slam · ATP · WTA',
    blurb: 'Desk predisposto per i circuiti con mercati di analisi. Archivio vuoto in attesa del provider ufficiale.',
    eventNoun: 'incontri',
  },
  {
    slug: 'volleyball',
    ...
    blurb: 'Modulo pronto. Nessun set o risultato viene generato in assenza di fonte.',
    eventNoun: 'incontri',
  },
  {
    slug: 'baseball',
  ...
  },
  {
    ...
    blurb: 'Calendario e classifiche solo da fonte ufficiale. Nessun tempo di gara simulato.',
    eventNoun: 'gare',
  },
  {
    slug: 'horse-racing',
  ...
  },
  {
    ...
    status: 'predisposed',
    focus: 'PGA · Major',
    blurb: 'Desk predisposto per i major e i circuiti. Nessun leaderboard fittizio.',
    eventNoun: 'tornei',
  },
  {
    slug: 'cycling',
