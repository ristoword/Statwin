...
export const SPORT_CATALOG: SportDefinition[] = [
  ...
  },
  {
    ...
    status: 'synced',
    focus: 'ATP · WTA',
    blurb: 'Circuiti ATP e WTA via TheSportsDB. Nessun risultato inventato.',
    eventNoun: 'incontri',
  },
  {
    slug: 'volleyball',
  ...
  },
  {
    ...
    status: 'predisposed',
    focus: 'Ippica · Trotto',
    blurb: 'Nessun feed pubblico legale collegato. L’archivio resta vuoto.',
    eventNoun: 'corse',
  },
  {
    slug: 'rugby',
    ...
    blurb: 'Premiership e Six Nations via TheSportsDB.',
    eventNoun: 'incontri',
  },
  {
    slug: 'handball',
