  ...
  return (
    <div>
      <div className="page-head">
        ...
        <Link className="btn" href="/admin/users/new">Nuovo account</Link>
      </div>
          ...
          <tbody>
            {users.length === 0 ? (
              ...
              users.map((user) => (
                <tr key={user.id}>
                  <td>
                    <Link className="link-row" href={`/admin/users/${user.id}`}>{user.email}</Link>
                  ...
                  <td>
                    <span className="badge badge-ai">{user.subscription?.plan ?? 'FREE'}</span>
                  </td>
                  <td>
                    <span className={user.isActive ? 'badge badge-data' : 'badge badge-off'}>
                  ...
                  <td>
                    <div className="actions">
                      <Link className="btn-ghost btn-sm" href={`/admin/users/${user.id}`}>Apri</Link>
                      {user.isActive ? (
