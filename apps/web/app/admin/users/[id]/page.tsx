...
import type { PasswordOnce, UserDossier } from '../../../../lib/admin-types';
  ...
  return (
    <div>
      <div className="page-head">
        ...
        <Link className="btn-ghost" href="/admin/users">Tutti gli utenti</Link>
      </div>
      ...
      {profile ? (
        <>
          ...
          <div className="card">
            <h3>Controlli</h3>
            <p className="disclaimer">Apri come utente non è consentito. Operazioni solo da questa control room.</p>
            <div className="actions">
              <button
                type="button"
                className={profile.isActive ? 'btn-danger' : 'btn'}
          ...
          <form className="card" onSubmit={saveProfile}>
            ...
            <p className="muted">Creato il {formatDateTime(profile.createdAt)} · ruolo {profile.role}</p>
            <button type="submit" className="btn" disabled={busy}>Salva profilo</button>
          </form>
